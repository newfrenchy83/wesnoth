...
void unit_attack::pre_show(window& window)
{
	...
	for(const auto & weapon : weapons_) {
		...
		std::string attw_specials_dmg = attacker_weapon.weapon_specials_value({"leadership", "damage", "special_alignment"});
		...
		std::string defw_specials_dmg = defender_attack ? defender_weapon.weapon_specials_value({"leadership", "damage", "special_alignment"}) : "";
